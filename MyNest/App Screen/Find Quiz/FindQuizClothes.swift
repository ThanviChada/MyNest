...
struct FindQuizClothes: View {
    
    @State private var selected: Set<String> = []
    @State private var goNext = false
    
    let options = ["Casual Wear", "Winter Clothing", "Athletics", "Formal", "Essentials/Basics"]
    
    var body: some View {
        NavigationStack {
            VStack(spacing: 25) {
                
                Text("What clothing do you need?")
...
struct FindQuizClothes_Previews: PreviewProvider {
